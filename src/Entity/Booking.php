...
class Booking
{
    ...
    public function getGestNumber(): ?int
    {
        return $this->gestNumber;
    }

    public function setGestNumber(int $gestNumber): static
    {
        $this->gestNumber = $gestNumber;
